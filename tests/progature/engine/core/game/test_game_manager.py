...
def test_game_manager_init(game):
    test_game_path = Path("progature/db/games") / game.file_name
...
def test_game_manager_game_complete(game):
    test_game_path = Path("progature/db/games") / game.file_name
    game = GameLoader.load(test_game_path.absolute())
    manager = GameManager(test_game_path)
...
def test_game_manager_chaper_complete(game):
    test_game_path = Path("progature/db/games") / game.file_name
    game = GameLoader.load(test_game_path.absolute())
    manager = GameManager(test_game_path)
...
def test_game_manager_level_complete(game):
    test_game_path = Path("progature/db/games") / game.file_name
    game = GameLoader.load(test_game_path.absolute())
    manager = GameManager(test_game_path)
...
def test_game_manager_quest_complete(game):
    test_game_path = Path("progature/db/games") / game.file_name
    game = GameLoader.load(test_game_path.absolute())
    manager = GameManager(test_game_path)
